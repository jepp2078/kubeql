...
type QueryResolver interface {
	...
	Pod(ctx context.Context, name string) (*Pod, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.Pod":
		...
		return e.complexity.Query.Pod(childComplexity, args["name"].(string)), true
...
func (ec *executionContext) _Query_pods(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNPod2ᚕgitlabᚗcomᚋwhyyyᚋkubeqlᚐPod(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_pod(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Pod(rctx, args["name"].(string))
	})
	if resTmp == nil {
		return graphql.Null
	}
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalOPod2ᚖgitlabᚗcomᚋwhyyyᚋkubeqlᚐPod(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPod2gitlabᚗcomᚋwhyyyᚋkubeqlᚐPod(ctx context.Context, sel ast.SelectionSet, v Pod) graphql.Marshaler {
	return ec._Pod(ctx, sel, &v)
}

func (ec *executionContext) marshalNPod2ᚕgitlabᚗcomᚋwhyyyᚋkubeqlᚐPod(ctx context.Context, sel ast.SelectionSet, v []Pod) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPod2gitlabᚗcomᚋwhyyyᚋkubeqlᚐPod(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOPod2gitlabᚗcomᚋwhyyyᚋkubeqlᚐPod(ctx context.Context, sel ast.SelectionSet, v Pod) graphql.Marshaler {
	return ec._Pod(ctx, sel, &v)
}

func (ec *executionContext) marshalOPod2ᚖgitlabᚗcomᚋwhyyyᚋkubeqlᚐPod(ctx context.Context, sel ast.SelectionSet, v *Pod) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Pod(ctx, sel, v)
